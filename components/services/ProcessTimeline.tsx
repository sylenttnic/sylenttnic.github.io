...
export default function ProcessTimeline() {
  return (
    <div className="relative border-l-2 border-[var(--border)] ml-4 md:ml-12 space-y-16 before:content-[''] before:absolute before:left-[-2px] before:top-0 before:w-[2px] before:h-24 before:bg-accent3 before:animate-flow-down before:rounded-sm">
      {phases.map((phase, index) => (
        ...
        >
          {/* Icon */}
          <div className="absolute -left-[1.35rem] top-0 bg-[var(--surface)] border-4 border-accent3 rounded-full p-2 text-accent3 shadow-[0_0_15px_var(--accent3)]">
            <phase.icon className="w-6 h-6" />
          </div>

          <div className="neon-card purple p-8 rounded-2xl group transition-all duration-300">
            <h3 className="text-2xl font-bold mb-6 text-white group-hover:text-accent3 transition-colors flex items-center flex-wrap gap-3">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-[var(--surface2)] p-6 rounded-xl border border-[var(--border)]">
                <h4 className="font-mono font-bold text-accent3 mb-2 text-sm uppercase tracking-wider">Our Solution:</h4>
