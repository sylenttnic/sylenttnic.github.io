...
export const metadata: Metadata = {
  ...
  description: 'Terms of Service for Sylentt Partners LLC.',
};
  ...
  return (
    <div className="pt-24 md:pt-36 pb-16 md:pb-24 px-6 max-w-4xl mx-auto">
      ...
      <p className="text-sm text-ink/60 pb-6 mb-8 border-b border-border">
        Sylentt Partners LLC, doing business as Sylentt · Effective 22 August 2026
      </p>
      ...
      <div className="prose prose-slate max-w-none text-ink/90 space-y-6">
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-2 mt-2">
            <li>The complete source files for the site.</li>
            <li>Full ownership of that site, transferred to you on payment (see below).</li>
            <li>Reasonable help getting it live on a domain and host of your choosing.</li>
          </ul>
        </section>

        <section>
          <h2 className="text-xl font-bold text-ink mt-8 mb-3">4. What is not included</h2>
        ...
        <section>
          <h2 className="text-xl font-bold text-ink mt-8 mb-3">5. Care plan (optional, sold separately)</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-ink mt-8 mb-3">6. Ownership</h2>
          <p>
            Once your payment clears, the website we built for you is yours. You own the design, layout, copy and files, and you may modify, host, sell or discard them as you see fit. We keep no claim over them. We may reference the work as an example of what we do, unless you ask us not to.
          </p>
          <p className="mt-3">
        ...
        <section>
          <h2 className="text-xl font-bold text-ink mt-8 mb-3">7. Imagery — please read this one</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-ink mt-8 mb-3">8. Your business information, and reviews</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-ink mt-8 mb-3">9. Refunds</h2>
          <p>
            See our <a href="/refunds" className="text-accent underline">refund policy</a>. In short: full refund within 14 days of purchase, no explanation required.
          </p>
        </section>

        <section>
          <h2 className="text-xl font-bold text-ink mt-8 mb-3">10. Payment</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-ink mt-8 mb-3">11. What we promise, and what we don&apos;t</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-ink mt-8 mb-3">12. Email from us</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-ink mt-8 mb-3">13. Changes to these terms</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-ink mt-8 mb-3">14. Governing law</h2>
          <p>
