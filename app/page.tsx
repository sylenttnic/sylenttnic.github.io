          ...
          <SectionFade>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-16">
              <div className="text-center p-8 rounded-2xl neon-card blue transition-all duration-300 group">
                <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-blue-500/10 shadow-xl shadow-black/20 text-accent mb-6 border border-blue-500/20 group-hover:bg-blue-500/20 group-hover:border-blue-500/50 group-hover:shadow-[0_0_15px_var(--accent)] transition-all duration-300">
              ...
              <div className="text-center p-8 rounded-2xl neon-card cyan transition-all duration-300 group">
                <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-cyan-500/10 shadow-xl shadow-black/20 text-accent2 mb-6 border border-cyan-500/20 group-hover:bg-cyan-500/20 group-hover:border-cyan-500/50 group-hover:shadow-[0_0_15px_var(--accent2)] transition-all duration-300">
                  <CheckCircle2 className="w-10 h-10" />
                </div>
              ...
              <div className="text-center p-8 rounded-2xl neon-card purple transition-all duration-300 group">
                <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-purple-500/10 shadow-xl shadow-black/20 text-accent3 mb-6 border border-purple-500/20 group-hover:bg-purple-500/20 group-hover:border-purple-500/50 group-hover:shadow-[0_0_15px_var(--accent3)] transition-all duration-300">
                  <CheckCircle2 className="w-10 h-10" />
                </div>
