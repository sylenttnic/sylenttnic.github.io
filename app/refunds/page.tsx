...
export const metadata: Metadata = {
  ...
  description: 'Refund Policy for Sylentt Partners LLC.',
};
    ...
    <div className="pt-24 md:pt-36 pb-16 md:pb-24 px-6 max-w-4xl mx-auto">
      ...
      <div className="prose prose-slate max-w-none text-ink/90 space-y-6">
        ...
        <section>
          ...
          <p>
            If you&apos;ve already received the site files, we ask that you stop using them and don&apos;t publish the site. We&apos;re not going to chase you over it, and we won&apos;t hold your refund hostage while we check. We&apos;d simply rather you took us at our word, as we&apos;re taking you at yours.
          </p>
        </section>
      ...
      <footer className="mt-14 pt-6 border-t border-border text-sm text-ink/60">
        Sylentt Partners LLC · 18121 E. Hampden Ave. Unit C - 751 Aurora, CO 80013 United States · <a href="mailto:support@sylentt.com" className="text-accent underline">support@sylentt.com</a>
      </footer>
    </div>
  );
}
