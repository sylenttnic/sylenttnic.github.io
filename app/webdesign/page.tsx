...
export const metadata: Metadata = {
  ...
  description:
    'A website designed and hand-built for one business — researched, written and coded from scratch. $499 one time, you own the code, 14-day refund.',
  alternates: {
...
const whatYouGetCards = [
  ...
  },
  {
    ...
    text: 'You get a repository you own — not a login to a platform. Hand it to any developer, any time, without asking us.',
  },
];
...
const ownershipBlocks = [
  {
    title: 'The deliverable is a repository',
    text: "Not a zip file and not a login. It's the actual code, in a repository you control, that any developer can pick up without contacting us.",
  },
  {
    title: 'Fourteen days to ask for your money back',
    text: 'Full refund, no conditions attached to the request.',
  },
  {
    title: 'The repository transfers on day fifteen',
    text: "Once the refund window closes. If you'd rather have it sooner, say so and we'll transfer early — taking ownership early ends the refund window, and we'll tell you that before you decide.",
  },
  {
    title: 'A domain we buy for you is yours',
    text: "Registered in your name, not ours. If you ever stop working with us, it doesn't go anywhere.",
  },
];
...
const faqItems = [
  ...
  },
  {
    ...
    a: "You'll have a date before you pay, and we hold to it. Most of the work — the research, the design, the writing — happens before you see anything, so what lands in front of you is a finished site to react to, not a project to manage.",
  },
  {
    q: 'Can I host it myself?',
    a: 'Yes. One thing to know if you plan to: our code host offers free hosting for public repositories. If you want the code kept private, that needs either a paid plan with them or staying on our care plan, where we host it for you and the repository can stay private. Neither option changes the website your customers see — only who can read the code behind it.',
  },
  {
    q: 'What if I need changes later?',
    a: "On the care plan, two content changes a month are included. Bigger work — new pages, new features, a redesign — is quoted separately. And because you own the code, you're never obliged to come back to us for any of it.",
  },
  {
      ...
      <section className="pt-24 md:pt-36 pb-16 md:pb-24 px-4 container mx-auto text-center border-b border-ink/5">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xs md:text-sm text-ink/60 font-sans">
            $499, one time. 14-day refund. You own the code. No calls, no contracts, no page builders.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-5xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch mb-8">
            ...
            <div className="bg-paper p-8 md:p-10 rounded-2xl border-2 border-accent shadow-lift flex flex-col justify-between relative">
              <span className="absolute -top-3 right-6 bg-accent text-paper text-xs font-bold uppercase tracking-widest px-3 py-1 rounded-full">
                Primary
              </span>
              <div>
                <h3 className="font-display text-2xl font-bold text-ink mb-2">Build</h3>
                <div className="flex items-baseline gap-2 mb-4">
                  <span className="font-display text-5xl font-bold text-ink">$499</span>
                  <span className="text-sm font-sans text-ink/60">one time</span>
                </div>
            ...
            {/* Card 2 — Hosting & Care */}
            <div className="bg-paper p-8 md:p-10 rounded-2xl border border-ink/10 shadow-soft flex flex-col justify-between">
              <div>
                <h3 className="font-display text-2xl font-bold text-ink mb-2">Hosting &amp; Care</h3>
                <div className="flex items-baseline gap-2 mb-4">
                  <span className="font-display text-5xl font-bold text-ink">$49</span>
                  <span className="text-sm font-sans text-ink/60">per month, optional</span>
                </div>
                <p className="text-base text-ink/80 font-sans mb-6 leading-relaxed">
                  We keep it running and keep it current.
                </p>
                <ul className="space-y-3 mb-6 font-sans text-sm md:text-base text-ink/90">
                  ...
                  <li className="flex items-start gap-3">
                    <Check className="w-5 h-5 text-accent shrink-0 mt-0.5" />
                    <span>Backups and uptime monitoring</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <Check className="w-5 h-5 text-accent shrink-0 mt-0.5" />
                ...
                <p className="text-xs text-ink/60 font-sans leading-relaxed mb-6">
                  Content changes don&apos;t roll over month to month. Redesigns, new pages and new functionality aren&apos;t included — those are quoted separately. Cancel any time.
                </p>
              </div>
              <div>
                <a
          ...
          <p className="text-center text-xs md:text-sm text-ink/60 font-sans max-w-2xl mx-auto">
            The care plan is optional and it is not a condition of the build. You own the code either way, and you&apos;re free to host it anywhere you like.
          </p>
        </div>
      </section>

      {/* Section 8 — Ownership and refunds */}
      <section className="py-16 md:py-24 px-4 container mx-auto">
        <div className="max-w-3xl mx-auto">
          <h2 className="font-display text-3xl md:text-5xl font-bold text-ink mb-12">
            You own it, and you can change your mind
          </h2>
